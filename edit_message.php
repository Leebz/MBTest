    ...
    <div id="submit">
        <?php if (empty($_POST['ac'])) { ?>
            ...
            <form name="form1" method="post" action="<?php $_SERVER['PHP_SELF'] ?>"
                ...
                <h2>
                    <img src="images/icon_write.gif"/><?php echo $rows['username'] ?> <font
                            style="color:#999;">于 <?php echo date("Y-m-d H:i", strtotime($rows["systime"])); ?>
                        发表留言：</font>
                </h2>　　
                <textarea name="content" cols="70" rows="9"
                          id="content"><?php echo ereg_replace("<br>　　", "\n", ereg_replace("&nbsp;", " ", $rows['content'])); ?></textarea><br>

                <span style="margin-left:80px;">管理员回复的内容：</span><br>
                <textarea name="reply" cols="50" rows="6"
                          id="reply_textarea"><?php echo ereg_replace("<br>　　", "\n", ereg_replace("&nbsp;", " ", $rows['reply'])); ?></textarea><br>
