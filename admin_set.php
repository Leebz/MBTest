        ...
        <?php if (empty($_POST['ac'])) { ?>
            <form name="form1" method="post" action="<?php $_SERVER['PHP_SELF'] ?>"
                ...
                <div id="submit_set_right">
                    <label for="gb_name">留言本的名称：</label><input type="text" name="gb_name"
                                                               value="<?php echo $gb_name; ?>"/>* 将显示在IE标题栏<br/>

                    <label for="gb_logo">留言本LOGO：</label><input type="text" name="gb_logo"
                                                                value="<?php echo $gb_logo; ?>"/>* 将显示在左上角<br/>
                    ...
                    <label for="gb_logo">留言需审开关：</label><input name="ifauditing" type="checkbox"
                                                               id="ifauditing" <?php if ($ifauditing == 1) echo 'checked'; ?>
                                                               value="1">选中此项后，新留言需要管理员审核后才能显示<br/>
